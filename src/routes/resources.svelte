<body>
  ...
  <div class="entryImg">
    ...
    <h2>Nice words about our awesome partners and affiliates.</h2>
...
<div class="affBox">
 ...
 By using TCN's Cloud-based Predictive Dialing tools and services, agencies can leverage the most sophisticated Outbound and Inbound calling technologies available, leveraging the cloud, all without capital outlay or new staff. Using TCN's revolutionary technologies, agencies can dramatically improve results and ROI. <br> Website: <br><a href="https://www.tcn.com/"> www.tcn.com </a></p>
  ...
  <div class="affBox-item">
    <h2>VoApps</h2>
    <img src="img/voapps.png" alt="voapps logo">
...
<div class="reqBox">
   <br> <h3>Debt$Net® PowerS System</h3>  <br>
    <div class="reqBox-item">
...
<div class="reqBox" id="bottom20" >
   <br> <h3>Debt$Net® PrestigeS System</h3>  <br>
    <div class="reqBox-item">
    <p>Server requirements:</p>
    </div>
  <div class="reqBox-item">
    ...
    <div class="reqBox-item">
    <p>2005 Standard or Newer</p>
    </div>

    <div class="reqBox-item">
    <p>2008 Standard or Newer</p>
    </div>
  ...
  <div class="reqBox-item">
    ...
    <div class="reqBox-item">
    <p>	Windows 7 Professional or Newer</p>
    </div>
