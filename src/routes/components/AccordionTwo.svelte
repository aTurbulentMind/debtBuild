...
<section class="panel" class:open-panel={isOpen}>
    <p>{content}</p>

    <div>
        <button on:click>Logo</button>
        <a href={learnmore} target="_blank"><button>Website</button></a>
    </div>
</section>
...
<style lang="scss">
    @import './src/routes/styles/components';
